...
namespace Common
{
    public static class LanguageFlags
    {
        public static Object GetFlag(Object value)
        {
            ...
            try
            {
                return new Bitmap(Path.GetFullPath($"{Directory.GetCurrentDirectory()}\\..\\..\\Common\\Images\\{countryId.ToLower()}.png"));
            }
            catch
            {
                return null;
    ...
    {
        public static readonly Dictionary<String, String> EnglishNameByIso2 = new Dictionary<String, String>(StringComparer.OrdinalIgnoreCase)
        {
