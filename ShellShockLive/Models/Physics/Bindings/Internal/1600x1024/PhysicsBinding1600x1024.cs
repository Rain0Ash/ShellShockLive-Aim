...
{
    public sealed class PhysicsBinding1600x1024 : InternalPhysicsBinding<PhysicsBinding1600x1024>
    {
        public override PhysicsBindings Type
        {
            get
            {
                return PhysicsBindings.Binding1600x1024;
            }
        }
