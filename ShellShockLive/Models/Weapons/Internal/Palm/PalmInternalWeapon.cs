...
{
    public abstract class PalmInternalWeapon<T> : InternalWeapon<T> where T : PalmInternalWeapon<T>, new()
    {
        ...
        public sealed override PalmWeaponStack Stack
        {
            get
            {
                return PalmWeaponStack.Instance;
            }
        }
    }
}