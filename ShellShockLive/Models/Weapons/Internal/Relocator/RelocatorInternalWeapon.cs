...
{
    public abstract class RelocatorInternalWeapon<T> : InternalWeapon<T> where T : RelocatorInternalWeapon<T>, new()
    {
        ...
        public sealed override RelocatorWeaponStack Stack
        {
            get
            {
                return RelocatorWeaponStack.Instance;
            }
        }
    }
}