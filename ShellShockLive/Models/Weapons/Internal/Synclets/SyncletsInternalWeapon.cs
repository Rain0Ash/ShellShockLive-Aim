...
{
    public abstract class SyncletsInternalWeapon<T> : InternalWeapon<T> where T : SyncletsInternalWeapon<T>, new()
    {
        ...
        public sealed override SyncletsWeaponStack Stack
        {
            get
            {
                return SyncletsWeaponStack.Instance;
            }
        }
    }
}