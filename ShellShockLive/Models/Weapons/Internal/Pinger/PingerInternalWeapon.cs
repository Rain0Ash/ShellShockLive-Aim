...
{
    public abstract class PingerInternalWeapon<T> : InternalWeapon<T> where T : PingerInternalWeapon<T>, new()
    {
        ...
        public sealed override PingerWeaponStack Stack
        {
            get
            {
                return PingerWeaponStack.Instance;
            }
        }
    }
}