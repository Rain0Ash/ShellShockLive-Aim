...
{
    public abstract class TweeterInternalWeapon<T> : InternalWeapon<T> where T : TweeterInternalWeapon<T>, new()
    {
        ...
        public sealed override TweeterWeaponStack Stack
        {
            get
            {
                return TweeterWeaponStack.Instance;
            }
        }
    }
}