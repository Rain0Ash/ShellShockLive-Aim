...
{
    public abstract class SpotterInternalWeapon<T> : InternalWeapon<T> where T : SpotterInternalWeapon<T>, new()
    {
        ...
        public sealed override SpotterWeaponStack Stack
        {
            get
            {
                return SpotterWeaponStack.Instance;
            }
        }
    }
}