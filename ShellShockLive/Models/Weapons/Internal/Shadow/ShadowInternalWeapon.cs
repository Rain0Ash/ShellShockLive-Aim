...
{
    public abstract class ShadowInternalWeapon<T> : InternalWeapon<T> where T : ShadowInternalWeapon<T>, new()
    {
        ...
        public sealed override ShadowWeaponStack Stack
        {
            get
            {
                return ShadowWeaponStack.Instance;
            }
        }
    }
}