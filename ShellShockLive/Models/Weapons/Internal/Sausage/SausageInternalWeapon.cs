...
{
    public abstract class SausageInternalWeapon<T> : InternalWeapon<T> where T : SausageInternalWeapon<T>, new()
    {
        ...
        public sealed override SausageWeaponStack Stack
        {
            get
            {
                return SausageWeaponStack.Instance;
            }
        }
    }
}