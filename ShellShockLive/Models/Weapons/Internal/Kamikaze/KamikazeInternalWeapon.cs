...
{
    public abstract class KamikazeInternalWeapon<T> : InternalWeapon<T> where T : KamikazeInternalWeapon<T>, new()
    {
        ...
        public sealed override KamikazeWeaponStack Stack
        {
            get
            {
                return KamikazeWeaponStack.Instance;
            }
        }
    }
}