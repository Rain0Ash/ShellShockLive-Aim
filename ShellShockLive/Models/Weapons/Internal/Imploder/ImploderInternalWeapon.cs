...
{
    public abstract class ImploderInternalWeapon<T> : InternalWeapon<T> where T : ImploderInternalWeapon<T>, new()
    {
        ...
        public sealed override ImploderWeaponStack Stack
        {
            get
            {
                return ImploderWeaponStack.Instance;
            }
        }
    }
}