...
{
    public abstract class FleetInternalWeapon<T> : InternalWeapon<T> where T : FleetInternalWeapon<T>, new()
    {
        ...
        public sealed override FleetWeaponStack Stack
        {
            get
            {
                return FleetWeaponStack.Instance;
            }
        }
    }
}