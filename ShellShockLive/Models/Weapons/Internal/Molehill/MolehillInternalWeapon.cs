...
{
    public abstract class MolehillInternalWeapon<T> : InternalWeapon<T> where T : MolehillInternalWeapon<T>, new()
    {
        ...
        public sealed override MolehillWeaponStack Stack
        {
            get
            {
                return MolehillWeaponStack.Instance;
            }
        }
    }
}