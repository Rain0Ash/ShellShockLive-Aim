...
{
    public abstract class ShrapnelInternalWeapon<T> : InternalWeapon<T> where T : ShrapnelInternalWeapon<T>, new()
    {
        ...
        public sealed override ShrapnelWeaponStack Stack
        {
            get
            {
                return ShrapnelWeaponStack.Instance;
            }
        }
    }
}