...
{
    public abstract class SatelliteInternalWeapon<T> : InternalWeapon<T> where T : SatelliteInternalWeapon<T>, new()
    {
        ...
        public sealed override SatelliteWeaponStack Stack
        {
            get
            {
                return SatelliteWeaponStack.Instance;
            }
        }
    }
}