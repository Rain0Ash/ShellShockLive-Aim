...
{
    public abstract class FlintlockInternalWeapon<T> : InternalWeapon<T> where T : FlintlockInternalWeapon<T>, new()
    {
        ...
        public sealed override FlintlockWeaponStack Stack
        {
            get
            {
                return FlintlockWeaponStack.Instance;
            }
        }
    }
}