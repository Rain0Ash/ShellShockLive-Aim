...
{
    public abstract class StoneInternalWeapon<T> : InternalWeapon<T> where T : StoneInternalWeapon<T>, new()
    {
        ...
        public sealed override StoneWeaponStack Stack
        {
            get
            {
                return StoneWeaponStack.Instance;
            }
        }
    }
}