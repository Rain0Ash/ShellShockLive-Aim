...
{
    public abstract class SinkholeInternalWeapon<T> : InternalWeapon<T> where T : SinkholeInternalWeapon<T>, new()
    {
        ...
        public sealed override SinkholeWeaponStack Stack
        {
            get
            {
                return SinkholeWeaponStack.Instance;
            }
        }
    }
}