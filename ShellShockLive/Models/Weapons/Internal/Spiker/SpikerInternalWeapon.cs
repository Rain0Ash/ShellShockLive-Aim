...
{
    public abstract class SpikerInternalWeapon<T> : InternalWeapon<T> where T : SpikerInternalWeapon<T>, new()
    {
        ...
        public sealed override SpikerWeaponStack Stack
        {
            get
            {
                return SpikerWeaponStack.Instance;
            }
        }
    }
}