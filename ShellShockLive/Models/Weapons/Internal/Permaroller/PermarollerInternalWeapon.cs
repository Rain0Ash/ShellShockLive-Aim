...
{
    public abstract class PermarollerInternalWeapon<T> : InternalWeapon<T> where T : PermarollerInternalWeapon<T>, new()
    {
        ...
        public sealed override PermarollerWeaponStack Stack
        {
            get
            {
                return PermarollerWeaponStack.Instance;
            }
        }
    }
}