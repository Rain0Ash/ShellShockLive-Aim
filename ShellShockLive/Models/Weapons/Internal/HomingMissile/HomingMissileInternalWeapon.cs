...
{
    public abstract class HomingMissileInternalWeapon<T> : InternalWeapon<T> where T : HomingMissileInternalWeapon<T>, new()
    {
        ...
        public sealed override HomingMissileWeaponStack Stack
        {
            get
            {
                return HomingMissileWeaponStack.Instance;
            }
        }
    }
}