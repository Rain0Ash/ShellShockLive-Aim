...
{
    public abstract class ShockwaveInternalWeapon<T> : InternalWeapon<T> where T : ShockwaveInternalWeapon<T>, new()
    {
        ...
        public sealed override ShockwaveWeaponStack Stack
        {
            get
            {
                return ShockwaveWeaponStack.Instance;
            }
        }
    }
}