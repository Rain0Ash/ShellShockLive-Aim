...
{
    public abstract class SeagullInternalWeapon<T> : InternalWeapon<T> where T : SeagullInternalWeapon<T>, new()
    {
        ...
        public sealed override SeagullWeaponStack Stack
        {
            get
            {
                return SeagullWeaponStack.Instance;
            }
        }
    }
}