...
{
    public abstract class SkeetInternalWeapon<T> : InternalWeapon<T> where T : SkeetInternalWeapon<T>, new()
    {
        ...
        public sealed override SkeetWeaponStack Stack
        {
            get
            {
                return SkeetWeaponStack.Instance;
            }
        }
    }
}