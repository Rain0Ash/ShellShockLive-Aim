...
{
    public abstract class MinionsInternalWeapon<T> : InternalWeapon<T> where T : MinionsInternalWeapon<T>, new()
    {
        ...
        public sealed override MinionsWeaponStack Stack
        {
            get
            {
                return MinionsWeaponStack.Instance;
            }
        }
    }
}