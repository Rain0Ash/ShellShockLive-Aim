...
{
    public abstract class RadarInternalWeapon<T> : InternalWeapon<T> where T : RadarInternalWeapon<T>, new()
    {
        ...
        public sealed override RadarWeaponStack Stack
        {
            get
            {
                return RadarWeaponStack.Instance;
            }
        }
    }
}