...
{
    public abstract class ChickenInternalWeapon<T> : InternalWeapon<T> where T : ChickenInternalWeapon<T>, new()
    {
        ...
        public sealed override ChickenWeaponStack Stack
        {
            get
            {
                return ChickenWeaponStack.Instance;
            }
        }
    }
}