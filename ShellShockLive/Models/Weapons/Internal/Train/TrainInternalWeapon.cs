...
{
    public abstract class TrainInternalWeapon<T> : InternalWeapon<T> where T : TrainInternalWeapon<T>, new()
    {
        ...
        public sealed override TrainWeaponStack Stack
        {
            get
            {
                return TrainWeaponStack.Instance;
            }
        }
    }
}