...
{
    public abstract class FuryInternalWeapon<T> : InternalWeapon<T> where T : FuryInternalWeapon<T>, new()
    {
        ...
        public sealed override FuryWeaponStack Stack
        {
            get
            {
                return FuryWeaponStack.Instance;
            }
        }
    }
}