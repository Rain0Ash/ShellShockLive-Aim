...
{
    public abstract class CloverInternalWeapon<T> : InternalWeapon<T> where T : CloverInternalWeapon<T>, new()
    {
        ...
        public sealed override CloverWeaponStack Stack
        {
            get
            {
                return CloverWeaponStack.Instance;
            }
        }
    }
}