...
{
    public abstract class StreamInternalWeapon<T> : InternalWeapon<T> where T : StreamInternalWeapon<T>, new()
    {
        ...
        public sealed override StreamWeaponStack Stack
        {
            get
            {
                return StreamWeaponStack.Instance;
            }
        }
    }
}