...
{
    public abstract class PartitionInternalWeapon<T> : InternalWeapon<T> where T : PartitionInternalWeapon<T>, new()
    {
        ...
        public sealed override PartitionWeaponStack Stack
        {
            get
            {
                return PartitionWeaponStack.Instance;
            }
        }
    }
}