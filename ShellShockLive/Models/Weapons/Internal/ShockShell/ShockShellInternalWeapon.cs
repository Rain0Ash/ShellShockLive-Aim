...
{
    public abstract class ShockShellInternalWeapon<T> : InternalWeapon<T> where T : ShockShellInternalWeapon<T>, new()
    {
        ...
        public sealed override ShockShellWeaponStack Stack
        {
            get
            {
                return ShockShellWeaponStack.Instance;
            }
        }
    }
}