...
{
    public abstract class ChunkletInternalWeapon<T> : InternalWeapon<T> where T : ChunkletInternalWeapon<T>, new()
    {
        ...
        public sealed override ChunkletWeaponStack Stack
        {
            get
            {
                return ChunkletWeaponStack.Instance;
            }
        }
    }
}