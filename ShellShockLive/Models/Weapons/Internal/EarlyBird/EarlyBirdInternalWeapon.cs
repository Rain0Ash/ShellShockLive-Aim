...
{
    public abstract class EarlyBirdInternalWeapon<T> : InternalWeapon<T> where T : EarlyBirdInternalWeapon<T>, new()
    {
        ...
        public sealed override EarlyBirdWeaponStack Stack
        {
            get
            {
                return EarlyBirdWeaponStack.Instance;
            }
        }
    }
}