...
{
    public abstract class SpazInternalWeapon<T> : InternalWeapon<T> where T : SpazInternalWeapon<T>, new()
    {
        ...
        public sealed override SpazWeaponStack Stack
        {
            get
            {
                return SpazWeaponStack.Instance;
            }
        }
    }
}