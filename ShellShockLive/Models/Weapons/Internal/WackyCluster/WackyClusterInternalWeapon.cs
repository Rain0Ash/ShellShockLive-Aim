...
{
    public abstract class WackyClusterInternalWeapon<T> : InternalWeapon<T> where T : WackyClusterInternalWeapon<T>, new()
    {
        ...
        public sealed override WackyClusterWeaponStack Stack
        {
            get
            {
                return WackyClusterWeaponStack.Instance;
            }
        }
    }
}