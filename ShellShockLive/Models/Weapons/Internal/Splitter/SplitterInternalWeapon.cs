...
{
    public abstract class SplitterInternalWeapon<T> : InternalWeapon<T> where T : SplitterInternalWeapon<T>, new()
    {
        ...
        public sealed override SplitterWeaponStack Stack
        {
            get
            {
                return SplitterWeaponStack.Instance;
            }
        }
    }
}