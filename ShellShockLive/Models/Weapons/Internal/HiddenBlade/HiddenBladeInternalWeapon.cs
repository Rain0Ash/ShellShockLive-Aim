...
{
    public abstract class HiddenBladeInternalWeapon<T> : InternalWeapon<T> where T : HiddenBladeInternalWeapon<T>, new()
    {
        ...
        public sealed override HiddenBladeWeaponStack Stack
        {
            get
            {
                return HiddenBladeWeaponStack.Instance;
            }
        }
    }
}