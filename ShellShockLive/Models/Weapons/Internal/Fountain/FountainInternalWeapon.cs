...
{
    public abstract class FountainInternalWeapon<T> : InternalWeapon<T> where T : FountainInternalWeapon<T>, new()
    {
        ...
        public sealed override FountainWeaponStack Stack
        {
            get
            {
                return FountainWeaponStack.Instance;
            }
        }
    }
}