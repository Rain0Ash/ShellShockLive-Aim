...
{
    public abstract class SprouterInternalWeapon<T> : InternalWeapon<T> where T : SprouterInternalWeapon<T>, new()
    {
        ...
        public sealed override SprouterWeaponStack Stack
        {
            get
            {
                return SprouterWeaponStack.Instance;
            }
        }
    }
}