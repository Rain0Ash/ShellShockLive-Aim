...
{
    public abstract class DeadWeightInternalWeapon<T> : InternalWeapon<T> where T : DeadWeightInternalWeapon<T>, new()
    {
        ...
        public sealed override DeadWeightWeaponStack Stack
        {
            get
            {
                return DeadWeightWeaponStack.Instance;
            }
        }
    }
}