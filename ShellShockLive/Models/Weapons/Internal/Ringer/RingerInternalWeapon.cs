...
{
    public abstract class RingerInternalWeapon<T> : InternalWeapon<T> where T : RingerInternalWeapon<T>, new()
    {
        ...
        public sealed override RingerWeaponStack Stack
        {
            get
            {
                return RingerWeaponStack.Instance;
            }
        }
    }
}