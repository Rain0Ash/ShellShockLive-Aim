...
{
    public abstract class BounceInternalWeapon<T> : InternalWeapon<T> where T : BounceInternalWeapon<T>, new()
    {
        ...
        public sealed override BounceWeaponStack Stack
        {
            get
            {
                return BounceWeaponStack.Instance;
            }
        }
    }
}