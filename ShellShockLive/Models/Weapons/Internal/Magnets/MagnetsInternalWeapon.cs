...
{
    public abstract class MagnetsInternalWeapon<T> : InternalWeapon<T> where T : MagnetsInternalWeapon<T>, new()
    {
        ...
        public sealed override MagnetsWeaponStack Stack
        {
            get
            {
                return MagnetsWeaponStack.Instance;
            }
        }
    }
}