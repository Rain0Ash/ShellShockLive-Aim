...
{
    public abstract class WaterBalloonInternalWeapon<T> : InternalWeapon<T> where T : WaterBalloonInternalWeapon<T>, new()
    {
        ...
        public sealed override WaterBalloonWeaponStack Stack
        {
            get
            {
                return WaterBalloonWeaponStack.Instance;
            }
        }
    }
}