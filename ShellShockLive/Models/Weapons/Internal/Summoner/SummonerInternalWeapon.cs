...
{
    public abstract class SummonerInternalWeapon<T> : InternalWeapon<T> where T : SummonerInternalWeapon<T>, new()
    {
        ...
        public sealed override SummonerWeaponStack Stack
        {
            get
            {
                return SummonerWeaponStack.Instance;
            }
        }
    }
}