...
{
    public abstract class TadpolesInternalWeapon<T> : InternalWeapon<T> where T : TadpolesInternalWeapon<T>, new()
    {
        ...
        public sealed override TadpolesWeaponStack Stack
        {
            get
            {
                return TadpolesWeaponStack.Instance;
            }
        }
    }
}