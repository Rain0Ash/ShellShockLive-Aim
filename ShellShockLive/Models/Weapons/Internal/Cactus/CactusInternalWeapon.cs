...
{
    public abstract class CactusInternalWeapon<T> : InternalWeapon<T> where T : CactusInternalWeapon<T>, new()
    {
        ...
        public sealed override CactusWeaponStack Stack
        {
            get
            {
                return CactusWeaponStack.Instance;
            }
        }
    }
}