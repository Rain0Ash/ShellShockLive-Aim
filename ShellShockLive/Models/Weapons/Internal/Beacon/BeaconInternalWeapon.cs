...
{
    public abstract class BeaconInternalWeapon<T> : InternalWeapon<T> where T : BeaconInternalWeapon<T>, new()
    {
        ...
        public sealed override BeaconWeaponStack Stack
        {
            get
            {
                return BeaconWeaponStack.Instance;
            }
        }
    }
}