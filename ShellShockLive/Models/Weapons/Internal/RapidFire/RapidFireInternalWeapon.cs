...
{
    public abstract class RapidFireInternalWeapon<T> : InternalWeapon<T> where T : RapidFireInternalWeapon<T>, new()
    {
        ...
        public sealed override RapidFireWeaponStack Stack
        {
            get
            {
                return RapidFireWeaponStack.Instance;
            }
        }
    }
}