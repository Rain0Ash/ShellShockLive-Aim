...
{
    public abstract class ChopperInternalWeapon<T> : InternalWeapon<T> where T : ChopperInternalWeapon<T>, new()
    {
        ...
        public sealed override ChopperWeaponStack Stack
        {
            get
            {
                return ChopperWeaponStack.Instance;
            }
        }
    }
}