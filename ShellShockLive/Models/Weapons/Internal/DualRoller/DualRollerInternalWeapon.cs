...
{
    public abstract class DualRollerInternalWeapon<T> : InternalWeapon<T> where T : DualRollerInternalWeapon<T>, new()
    {
        ...
        public sealed override DualRollerWeaponStack Stack
        {
            get
            {
                return DualRollerWeaponStack.Instance;
            }
        }
    }
}