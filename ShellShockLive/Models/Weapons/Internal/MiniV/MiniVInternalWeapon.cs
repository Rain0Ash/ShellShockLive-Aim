...
{
    public abstract class MiniVInternalWeapon<T> : InternalWeapon<T> where T : MiniVInternalWeapon<T>, new()
    {
        ...
        public sealed override MiniVWeaponStack Stack
        {
            get
            {
                return MiniVWeaponStack.Instance;
            }
        }
    }
}