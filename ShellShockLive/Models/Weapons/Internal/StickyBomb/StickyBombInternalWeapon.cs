...
{
    public abstract class StickyBombInternalWeapon<T> : InternalWeapon<T> where T : StickyBombInternalWeapon<T>, new()
    {
        ...
        public sealed override StickyBombWeaponStack Stack
        {
            get
            {
                return StickyBombWeaponStack.Instance;
            }
        }
    }
}