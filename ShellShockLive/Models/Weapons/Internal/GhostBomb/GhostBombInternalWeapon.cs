...
{
    public abstract class GhostBombInternalWeapon<T> : InternalWeapon<T> where T : GhostBombInternalWeapon<T>, new()
    {
        ...
        public sealed override GhostBombWeaponStack Stack
        {
            get
            {
                return GhostBombWeaponStack.Instance;
            }
        }
    }
}