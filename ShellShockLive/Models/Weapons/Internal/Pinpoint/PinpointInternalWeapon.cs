...
{
    public abstract class PinpointInternalWeapon<T> : InternalWeapon<T> where T : PinpointInternalWeapon<T>, new()
    {
        ...
        public sealed override PinpointWeaponStack Stack
        {
            get
            {
                return PinpointWeaponStack.Instance;
            }
        }
    }
}