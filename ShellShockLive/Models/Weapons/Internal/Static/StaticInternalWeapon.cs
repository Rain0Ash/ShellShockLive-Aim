...
{
    public abstract class StaticInternalWeapon<T> : InternalWeapon<T> where T : StaticInternalWeapon<T>, new()
    {
        ...
        public sealed override StaticWeaponStack Stack
        {
            get
            {
                return StaticWeaponStack.Instance;
            }
        }
    }
}