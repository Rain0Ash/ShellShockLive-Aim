...
{
    public abstract class BounsplodeInternalWeapon<T> : InternalWeapon<T> where T : BounsplodeInternalWeapon<T>, new()
    {
        ...
        public sealed override BounsplodeWeaponStack Stack
        {
            get
            {
                return BounsplodeWeaponStack.Instance;
            }
        }
    }
}