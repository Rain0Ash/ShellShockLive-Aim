...
{
    public abstract class BuilderInternalWeapon<T> : InternalWeapon<T> where T : BuilderInternalWeapon<T>, new()
    {
        ...
        public sealed override BuilderWeaponStack Stack
        {
            get
            {
                return BuilderWeaponStack.Instance;
            }
        }
    }
}