...
{
    public abstract class PayloadInternalWeapon<T> : InternalWeapon<T> where T : PayloadInternalWeapon<T>, new()
    {
        ...
        public sealed override PayloadWeaponStack Stack
        {
            get
            {
                return PayloadWeaponStack.Instance;
            }
        }
    }
}