...
{
    public abstract class AirStrikeInternalWeapon<T> : InternalWeapon<T> where T : AirStrikeInternalWeapon<T>, new()
    {
        ...
        public sealed override AirStrikeWeaponStack Stack
        {
            get
            {
                return AirStrikeWeaponStack.Instance;
            }
        }
    }
}