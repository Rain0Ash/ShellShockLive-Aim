...
{
    public abstract class TwinklerInternalWeapon<T> : InternalWeapon<T> where T : TwinklerInternalWeapon<T>, new()
    {
        ...
        public sealed override TwinklerWeaponStack Stack
        {
            get
            {
                return TwinklerWeaponStack.Instance;
            }
        }
    }
}