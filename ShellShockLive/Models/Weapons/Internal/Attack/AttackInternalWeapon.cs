...
{
    public abstract class AttackInternalWeapon<T> : InternalWeapon<T> where T : AttackInternalWeapon<T>, new()
    {
        ...
        public sealed override AttackWeaponStack Stack
        {
            get
            {
                return AttackWeaponStack.Instance;
            }
        }
    }
}