...
{
    public abstract class CounterInternalWeapon<T> : InternalWeapon<T> where T : CounterInternalWeapon<T>, new()
    {
        ...
        public sealed override CounterWeaponStack Stack
        {
            get
            {
                return CounterWeaponStack.Instance;
            }
        }
    }
}