...
{
    public abstract class BothererInternalWeapon<T> : InternalWeapon<T> where T : BothererInternalWeapon<T>, new()
    {
        ...
        public sealed override BothererWeaponStack Stack
        {
            get
            {
                return BothererWeaponStack.Instance;
            }
        }
    }
}