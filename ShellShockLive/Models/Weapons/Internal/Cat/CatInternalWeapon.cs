...
{
    public abstract class CatInternalWeapon<T> : InternalWeapon<T> where T : CatInternalWeapon<T>, new()
    {
        ...
        public sealed override CatWeaponStack Stack
        {
            get
            {
                return CatWeaponStack.Instance;
            }
        }
    }
}