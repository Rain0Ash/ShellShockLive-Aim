...
{
    public abstract class GrenadeInternalWeapon<T> : InternalWeapon<T> where T : GrenadeInternalWeapon<T>, new()
    {
        ...
        public sealed override GrenadeWeaponStack Stack
        {
            get
            {
                return GrenadeWeaponStack.Instance;
            }
        }
    }
}