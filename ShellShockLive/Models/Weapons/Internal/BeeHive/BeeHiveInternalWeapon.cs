...
{
    public abstract class BeeHiveInternalWeapon<T> : InternalWeapon<T> where T : BeeHiveInternalWeapon<T>, new()
    {
        ...
        public sealed override BeeHiveWeaponStack Stack
        {
            get
            {
                return BeeHiveWeaponStack.Instance;
            }
        }
    }
}