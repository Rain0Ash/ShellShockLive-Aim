...
{
    public abstract class UziInternalWeapon<T> : InternalWeapon<T> where T : UziInternalWeapon<T>, new()
    {
        ...
        public sealed override UziWeaponStack Stack
        {
            get
            {
                return UziWeaponStack.Instance;
            }
        }
    }
}