...
{
    public abstract class JumperInternalWeapon<T> : InternalWeapon<T> where T : JumperInternalWeapon<T>, new()
    {
        ...
        public sealed override JumperWeaponStack Stack
        {
            get
            {
                return JumperWeaponStack.Instance;
            }
        }
    }
}