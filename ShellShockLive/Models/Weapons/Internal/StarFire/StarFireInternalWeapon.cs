...
{
    public abstract class StarFireInternalWeapon<T> : InternalWeapon<T> where T : StarFireInternalWeapon<T>, new()
    {
        ...
        public sealed override StarFireWeaponStack Stack
        {
            get
            {
                return StarFireWeaponStack.Instance;
            }
        }
    }
}