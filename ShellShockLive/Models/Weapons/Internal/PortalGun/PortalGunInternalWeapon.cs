...
{
    public abstract class PortalGunInternalWeapon<T> : InternalWeapon<T> where T : PortalGunInternalWeapon<T>, new()
    {
        ...
        public sealed override PortalGunWeaponStack Stack
        {
            get
            {
                return PortalGunWeaponStack.Instance;
            }
        }
    }
}