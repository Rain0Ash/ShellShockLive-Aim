...
{
    public abstract class SawBladeInternalWeapon<T> : InternalWeapon<T> where T : SawBladeInternalWeapon<T>, new()
    {
        ...
        public sealed override SawBladeWeaponStack Stack
        {
            get
            {
                return SawBladeWeaponStack.Instance;
            }
        }
    }
}