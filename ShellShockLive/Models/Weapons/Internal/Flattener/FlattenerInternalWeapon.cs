...
{
    public abstract class FlattenerInternalWeapon<T> : InternalWeapon<T> where T : FlattenerInternalWeapon<T>, new()
    {
        ...
        public sealed override FlattenerWeaponStack Stack
        {
            get
            {
                return FlattenerWeaponStack.Instance;
            }
        }
    }
}