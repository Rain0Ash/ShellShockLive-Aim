...
{
    public abstract class FatStacksInternalWeapon<T> : InternalWeapon<T> where T : FatStacksInternalWeapon<T>, new()
    {
        ...
        public sealed override FatStacksWeaponStack Stack
        {
            get
            {
                return FatStacksWeaponStack.Instance;
            }
        }
    }
}