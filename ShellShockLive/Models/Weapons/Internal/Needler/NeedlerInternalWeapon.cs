...
{
    public abstract class NeedlerInternalWeapon<T> : InternalWeapon<T> where T : NeedlerInternalWeapon<T>, new()
    {
        ...
        public sealed override NeedlerWeaponStack Stack
        {
            get
            {
                return NeedlerWeaponStack.Instance;
            }
        }
    }
}