...
{
    public abstract class BananaInternalWeapon<T> : InternalWeapon<T> where T : BananaInternalWeapon<T>, new()
    {
        ...
        public sealed override BananaWeaponStack Stack
        {
            get
            {
                return BananaWeaponStack.Instance;
            }
        }
    }
}