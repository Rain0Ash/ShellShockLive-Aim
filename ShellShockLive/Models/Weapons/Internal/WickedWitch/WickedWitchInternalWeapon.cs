...
{
    public abstract class WickedWitchInternalWeapon<T> : InternalWeapon<T> where T : WickedWitchInternalWeapon<T>, new()
    {
        ...
        public sealed override WickedWitchWeaponStack Stack
        {
            get
            {
                return WickedWitchWeaponStack.Instance;
            }
        }
    }
}