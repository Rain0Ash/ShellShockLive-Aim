...
{
    public abstract class YinYangInternalWeapon<T> : InternalWeapon<T> where T : YinYangInternalWeapon<T>, new()
    {
        ...
        public sealed override YinYangWeaponStack Stack
        {
            get
            {
                return YinYangWeaponStack.Instance;
            }
        }
    }
}