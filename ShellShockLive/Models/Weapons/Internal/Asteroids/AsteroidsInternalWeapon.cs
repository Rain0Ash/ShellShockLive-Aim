...
{
    public abstract class AsteroidsInternalWeapon<T> : InternalWeapon<T> where T : AsteroidsInternalWeapon<T>, new()
    {
        ...
        public sealed override AsteroidsWeaponStack Stack
        {
            get
            {
                return AsteroidsWeaponStack.Instance;
            }
        }
    }
}