...
{
    public abstract class TangentFireInternalWeapon<T> : InternalWeapon<T> where T : TangentFireInternalWeapon<T>, new()
    {
        ...
        public sealed override TangentFireWeaponStack Stack
        {
            get
            {
                return TangentFireWeaponStack.Instance;
            }
        }
    }
}