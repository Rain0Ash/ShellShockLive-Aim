...
{
    public abstract class TunnelerInternalWeapon<T> : InternalWeapon<T> where T : TunnelerInternalWeapon<T>, new()
    {
        ...
        public sealed override TunnelerWeaponStack Stack
        {
            get
            {
                return TunnelerWeaponStack.Instance;
            }
        }
    }
}