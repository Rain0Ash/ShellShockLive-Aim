...
{
    public abstract class ZipperInternalWeapon<T> : InternalWeapon<T> where T : ZipperInternalWeapon<T>, new()
    {
        ...
        public sealed override ZipperWeaponStack Stack
        {
            get
            {
                return ZipperWeaponStack.Instance;
            }
        }
    }
}