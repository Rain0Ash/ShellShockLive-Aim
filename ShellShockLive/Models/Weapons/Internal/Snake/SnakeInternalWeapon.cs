...
{
    public abstract class SnakeInternalWeapon<T> : InternalWeapon<T> where T : SnakeInternalWeapon<T>, new()
    {
        ...
        public sealed override SnakeWeaponStack Stack
        {
            get
            {
                return SnakeWeaponStack.Instance;
            }
        }
    }
}