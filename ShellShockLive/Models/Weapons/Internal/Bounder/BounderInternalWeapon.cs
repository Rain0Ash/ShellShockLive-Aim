...
{
    public abstract class BounderInternalWeapon<T> : InternalWeapon<T> where T : BounderInternalWeapon<T>, new()
    {
        ...
        public sealed override BounderWeaponStack Stack
        {
            get
            {
                return BounderWeaponStack.Instance;
            }
        }
    }
}