...
{
    public abstract class SillyballsInternalWeapon<T> : InternalWeapon<T> where T : SillyballsInternalWeapon<T>, new()
    {
        ...
        public sealed override SillyballsWeaponStack Stack
        {
            get
            {
                return SillyballsWeaponStack.Instance;
            }
        }
    }
}