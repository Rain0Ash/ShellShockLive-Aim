...
{
    public abstract class ArrowInternalWeapon<T> : InternalWeapon<T> where T : ArrowInternalWeapon<T>, new()
    {
        ...
        public sealed override ArrowWeaponStack Stack
        {
            get
            {
                return ArrowWeaponStack.Instance;
            }
        }
    }
}