...
{
    public abstract class OddballInternalWeapon<T> : InternalWeapon<T> where T : OddballInternalWeapon<T>, new()
    {
        ...
        public sealed override OddballWeaponStack Stack
        {
            get
            {
                return OddballWeaponStack.Instance;
            }
        }
    }
}