...
{
    public abstract class SnowballInternalWeapon<T> : InternalWeapon<T> where T : SnowballInternalWeapon<T>, new()
    {
        ...
        public sealed override SnowballWeaponStack Stack
        {
            get
            {
                return SnowballWeaponStack.Instance;
            }
        }
    }
}