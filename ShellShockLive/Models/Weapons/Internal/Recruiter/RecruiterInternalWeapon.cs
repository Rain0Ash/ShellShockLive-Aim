...
{
    public abstract class RecruiterInternalWeapon<T> : InternalWeapon<T> where T : RecruiterInternalWeapon<T>, new()
    {
        ...
        public sealed override RecruiterWeaponStack Stack
        {
            get
            {
                return RecruiterWeaponStack.Instance;
            }
        }
    }
}