...
{
    public abstract class PistolInternalWeapon<T> : InternalWeapon<T> where T : PistolInternalWeapon<T>, new()
    {
        ...
        public sealed override PistolWeaponStack Stack
        {
            get
            {
                return PistolWeaponStack.Instance;
            }
        }
    }
}