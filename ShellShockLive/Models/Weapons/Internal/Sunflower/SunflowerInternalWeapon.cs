...
{
    public abstract class SunflowerInternalWeapon<T> : InternalWeapon<T> where T : SunflowerInternalWeapon<T>, new()
    {
        ...
        public sealed override SunflowerWeaponStack Stack
        {
            get
            {
                return SunflowerWeaponStack.Instance;
            }
        }
    }
}