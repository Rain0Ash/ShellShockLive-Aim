...
{
    public abstract class BulgerInternalWeapon<T> : InternalWeapon<T> where T : BulgerInternalWeapon<T>, new()
    {
        ...
        public sealed override BulgerWeaponStack Stack
        {
            get
            {
                return BulgerWeaponStack.Instance;
            }
        }
    }
}