...
{
    public abstract class HorizonInternalWeapon<T> : InternalWeapon<T> where T : HorizonInternalWeapon<T>, new()
    {
        ...
        public sealed override HorizonWeaponStack Stack
        {
            get
            {
                return HorizonWeaponStack.Instance;
            }
        }
    }
}