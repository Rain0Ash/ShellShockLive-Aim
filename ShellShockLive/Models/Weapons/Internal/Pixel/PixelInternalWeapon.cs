...
{
    public abstract class PixelInternalWeapon<T> : InternalWeapon<T> where T : PixelInternalWeapon<T>, new()
    {
        ...
        public sealed override PixelWeaponStack Stack
        {
            get
            {
                return PixelWeaponStack.Instance;
            }
        }
    }
}