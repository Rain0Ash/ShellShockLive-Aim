...
{
    public abstract class EarthquakeInternalWeapon<T> : InternalWeapon<T> where T : EarthquakeInternalWeapon<T>, new()
    {
        ...
        public sealed override EarthquakeWeaponStack Stack
        {
            get
            {
                return EarthquakeWeaponStack.Instance;
            }
        }
    }
}