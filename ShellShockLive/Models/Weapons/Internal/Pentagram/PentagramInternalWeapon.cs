...
{
    public abstract class PentagramInternalWeapon<T> : InternalWeapon<T> where T : PentagramInternalWeapon<T>, new()
    {
        ...
        public sealed override PentagramWeaponStack Stack
        {
            get
            {
                return PentagramWeaponStack.Instance;
            }
        }
    }
}