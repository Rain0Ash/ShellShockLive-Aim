...
{
    public abstract class DroneInternalWeapon<T> : InternalWeapon<T> where T : DroneInternalWeapon<T>, new()
    {
        ...
        public sealed override DroneWeaponStack Stack
        {
            get
            {
                return DroneWeaponStack.Instance;
            }
        }
    }
}