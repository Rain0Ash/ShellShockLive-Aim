...
{
    public abstract class BreakerInternalWeapon<T> : InternalWeapon<T> where T : BreakerInternalWeapon<T>, new()
    {
        ...
        public sealed override BreakerWeaponStack Stack
        {
            get
            {
                return BreakerWeaponStack.Instance;
            }
        }
    }
}