...
{
    public abstract class FlasherInternalWeapon<T> : InternalWeapon<T> where T : FlasherInternalWeapon<T>, new()
    {
        ...
        public sealed override FlasherWeaponStack Stack
        {
            get
            {
                return FlasherWeaponStack.Instance;
            }
        }
    }
}