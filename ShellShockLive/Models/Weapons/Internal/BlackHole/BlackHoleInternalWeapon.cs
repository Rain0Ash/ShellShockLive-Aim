...
{
    public abstract class BlackHoleInternalWeapon<T> : InternalWeapon<T> where T : BlackHoleInternalWeapon<T>, new()
    {
        ...
        public sealed override BlackHoleWeaponStack Stack
        {
            get
            {
                return BlackHoleWeaponStack.Instance;
            }
        }
    }
}