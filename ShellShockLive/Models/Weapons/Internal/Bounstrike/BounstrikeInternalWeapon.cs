...
{
    public abstract class BounstrikeInternalWeapon<T> : InternalWeapon<T> where T : BounstrikeInternalWeapon<T>, new()
    {
        ...
        public sealed override BounstrikeWeaponStack Stack
        {
            get
            {
                return BounstrikeWeaponStack.Instance;
            }
        }
    }
}