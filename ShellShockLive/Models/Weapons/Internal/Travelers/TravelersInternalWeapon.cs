...
{
    public abstract class TravelersInternalWeapon<T> : InternalWeapon<T> where T : TravelersInternalWeapon<T>, new()
    {
        ...
        public sealed override TravelersWeaponStack Stack
        {
            get
            {
                return TravelersWeaponStack.Instance;
            }
        }
    }
}