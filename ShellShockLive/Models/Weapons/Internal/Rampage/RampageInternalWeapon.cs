...
{
    public abstract class RampageInternalWeapon<T> : InternalWeapon<T> where T : RampageInternalWeapon<T>, new()
    {
        ...
        public sealed override RampageWeaponStack Stack
        {
            get
            {
                return RampageWeaponStack.Instance;
            }
        }
    }
}