...
{
    public abstract class QuicksandInternalWeapon<T> : InternalWeapon<T> where T : QuicksandInternalWeapon<T>, new()
    {
        ...
        public sealed override QuicksandWeaponStack Stack
        {
            get
            {
                return QuicksandWeaponStack.Instance;
            }
        }
    }
}