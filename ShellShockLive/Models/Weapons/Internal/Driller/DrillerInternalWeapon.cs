...
{
    public abstract class DrillerInternalWeapon<T> : InternalWeapon<T> where T : DrillerInternalWeapon<T>, new()
    {
        ...
        public sealed override DrillerWeaponStack Stack
        {
            get
            {
                return DrillerWeaponStack.Instance;
            }
        }
    }
}