...
{
    public abstract class DiggerInternalWeapon<T> : InternalWeapon<T> where T : DiggerInternalWeapon<T>, new()
    {
        ...
        public sealed override DiggerWeaponStack Stack
        {
            get
            {
                return DiggerWeaponStack.Instance;
            }
        }
    }
}