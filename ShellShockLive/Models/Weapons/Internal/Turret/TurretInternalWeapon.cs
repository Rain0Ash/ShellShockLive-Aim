...
{
    public abstract class TurretInternalWeapon<T> : InternalWeapon<T> where T : TurretInternalWeapon<T>, new()
    {
        ...
        public sealed override TurretWeaponStack Stack
        {
            get
            {
                return TurretWeaponStack.Instance;
            }
        }
    }
}