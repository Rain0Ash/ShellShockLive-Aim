...
{
    public abstract class MoonsInternalWeapon<T> : InternalWeapon<T> where T : MoonsInternalWeapon<T>, new()
    {
        ...
        public sealed override MoonsWeaponStack Stack
        {
            get
            {
                return MoonsWeaponStack.Instance;
            }
        }
    }
}