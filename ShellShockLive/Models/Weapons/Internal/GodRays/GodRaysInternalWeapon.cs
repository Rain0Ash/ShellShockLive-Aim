...
{
    public abstract class GodRaysInternalWeapon<T> : InternalWeapon<T> where T : GodRaysInternalWeapon<T>, new()
    {
        ...
        public sealed override GodRaysWeaponStack Stack
        {
            get
            {
                return GodRaysWeaponStack.Instance;
            }
        }
    }
}