...
{
    public abstract class CarpetBombInternalWeapon<T> : InternalWeapon<T> where T : CarpetBombInternalWeapon<T>, new()
    {
        ...
        public sealed override CarpetBombWeaponStack Stack
        {
            get
            {
                return CarpetBombWeaponStack.Instance;
            }
        }
    }
}