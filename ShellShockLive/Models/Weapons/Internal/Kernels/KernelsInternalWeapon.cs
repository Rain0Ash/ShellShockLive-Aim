...
{
    public abstract class KernelsInternalWeapon<T> : InternalWeapon<T> where T : KernelsInternalWeapon<T>, new()
    {
        ...
        public sealed override KernelsWeaponStack Stack
        {
            get
            {
                return KernelsWeaponStack.Instance;
            }
        }
    }
}