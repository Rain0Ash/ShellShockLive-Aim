...
{
    public abstract class FlameInternalWeapon<T> : InternalWeapon<T> where T : FlameInternalWeapon<T>, new()
    {
        ...
        public sealed override FlameWeaponStack Stack
        {
            get
            {
                return FlameWeaponStack.Instance;
            }
        }
    }
}