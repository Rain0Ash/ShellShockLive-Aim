...
{
    public abstract class BFGInternalWeapon<T> : InternalWeapon<T> where T : BFGInternalWeapon<T>, new()
    {
        ...
        public sealed override BFGWeaponStack Stack
        {
            get
            {
                return BFGWeaponStack.Instance;
            }
        }
    }
}