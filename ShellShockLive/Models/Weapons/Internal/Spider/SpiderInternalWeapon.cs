...
{
    public abstract class SpiderInternalWeapon<T> : InternalWeapon<T> where T : SpiderInternalWeapon<T>, new()
    {
        ...
        public sealed override SpiderWeaponStack Stack
        {
            get
            {
                return SpiderWeaponStack.Instance;
            }
        }
    }
}