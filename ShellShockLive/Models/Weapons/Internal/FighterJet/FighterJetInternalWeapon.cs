...
{
    public abstract class FighterJetInternalWeapon<T> : InternalWeapon<T> where T : FighterJetInternalWeapon<T>, new()
    {
        ...
        public sealed override FighterJetWeaponStack Stack
        {
            get
            {
                return FighterJetWeaponStack.Instance;
            }
        }
    }
}