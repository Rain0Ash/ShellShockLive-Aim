...
{
    public abstract class NukeInternalWeapon<T> : InternalWeapon<T> where T : NukeInternalWeapon<T>, new()
    {
        ...
        public sealed override NukeWeaponStack Stack
        {
            get
            {
                return NukeWeaponStack.Instance;
            }
        }
    }
}