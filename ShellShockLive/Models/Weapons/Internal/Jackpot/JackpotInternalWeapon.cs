...
{
    public abstract class JackpotInternalWeapon<T> : InternalWeapon<T> where T : JackpotInternalWeapon<T>, new()
    {
        ...
        public sealed override JackpotWeaponStack Stack
        {
            get
            {
                return JackpotWeaponStack.Instance;
            }
        }
    }
}