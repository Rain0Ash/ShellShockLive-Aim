...
{
    public abstract class LaserBeamInternalWeapon<T> : InternalWeapon<T> where T : LaserBeamInternalWeapon<T>, new()
    {
        ...
        public sealed override LaserBeamWeaponStack Stack
        {
            get
            {
                return LaserBeamWeaponStack.Instance;
            }
        }
    }
}