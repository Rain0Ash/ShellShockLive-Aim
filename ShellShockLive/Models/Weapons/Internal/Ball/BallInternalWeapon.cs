...
{
    public abstract class BallInternalWeapon<T> : InternalWeapon<T> where T : BallInternalWeapon<T>, new()
    {
        ...
        public sealed override BallWeaponStack Stack
        {
            get
            {
                return BallWeaponStack.Instance;
            }
        }
    }
}