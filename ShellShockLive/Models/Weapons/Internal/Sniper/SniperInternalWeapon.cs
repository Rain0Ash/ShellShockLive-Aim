...
{
    public abstract class SniperInternalWeapon<T> : InternalWeapon<T> where T : SniperInternalWeapon<T>, new()
    {
        ...
        public sealed override SniperWeaponStack Stack
        {
            get
            {
                return SniperWeaponStack.Instance;
            }
        }
    }
}