...
{
    public abstract class BirdsInternalWeapon<T> : InternalWeapon<T> where T : BirdsInternalWeapon<T>, new()
    {
        ...
        public sealed override BirdsWeaponStack Stack
        {
            get
            {
                return BirdsWeaponStack.Instance;
            }
        }
    }
}