...
{
    public abstract class BackRollerInternalWeapon<T> : InternalWeapon<T> where T : BackRollerInternalWeapon<T>, new()
    {
        ...
        public sealed override BackRollerWeaponStack Stack
        {
            get
            {
                return BackRollerWeaponStack.Instance;
            }
        }
    }
}