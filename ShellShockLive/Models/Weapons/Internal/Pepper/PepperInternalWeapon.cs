...
{
    public abstract class PepperInternalWeapon<T> : InternalWeapon<T> where T : PepperInternalWeapon<T>, new()
    {
        ...
        public sealed override PepperWeaponStack Stack
        {
            get
            {
                return PepperWeaponStack.Instance;
            }
        }
    }
}