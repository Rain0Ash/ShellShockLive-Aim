...
{
    public abstract class FireworksInternalWeapon<T> : InternalWeapon<T> where T : FireworksInternalWeapon<T>, new()
    {
        ...
        public sealed override FireworksWeaponStack Stack
        {
            get
            {
                return FireworksWeaponStack.Instance;
            }
        }
    }
}