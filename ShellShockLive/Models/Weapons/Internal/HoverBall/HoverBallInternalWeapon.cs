...
{
    public abstract class HoverBallInternalWeapon<T> : InternalWeapon<T> where T : HoverBallInternalWeapon<T>, new()
    {
        ...
        public sealed override HoverBallWeaponStack Stack
        {
            get
            {
                return HoverBallWeaponStack.Instance;
            }
        }
    }
}