...
{
    public abstract class ShotInternalWeapon<T> : InternalWeapon<T> where T : ShotInternalWeapon<T>, new()
    {
        ...
        public sealed override ShotWeaponStack Stack
        {
            get
            {
                return ShotWeaponStack.Instance;
            }
        }
    }
}