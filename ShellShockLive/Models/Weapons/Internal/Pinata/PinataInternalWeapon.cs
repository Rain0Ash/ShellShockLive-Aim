...
{
    public abstract class PinataInternalWeapon<T> : InternalWeapon<T> where T : PinataInternalWeapon<T>, new()
    {
        ...
        public sealed override PinataWeaponStack Stack
        {
            get
            {
                return PinataWeaponStack.Instance;
            }
        }
    }
}