...
{
    public abstract class RollerInternalWeapon<T> : InternalWeapon<T> where T : RollerInternalWeapon<T>, new()
    {
        ...
        public sealed override RollerWeaponStack Stack
        {
            get
            {
                return RollerWeaponStack.Instance;
            }
        }
    }
}