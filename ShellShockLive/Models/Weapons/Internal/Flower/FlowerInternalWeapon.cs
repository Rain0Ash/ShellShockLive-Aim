...
{
    public abstract class FlowerInternalWeapon<T> : InternalWeapon<T> where T : FlowerInternalWeapon<T>, new()
    {
        ...
        public sealed override FlowerWeaponStack Stack
        {
            get
            {
                return FlowerWeaponStack.Instance;
            }
        }
    }
}