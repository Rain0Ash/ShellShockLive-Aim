...
{
    public abstract class BoltInternalWeapon<T> : InternalWeapon<T> where T : BoltInternalWeapon<T>, new()
    {
        ...
        public sealed override BoltWeaponStack Stack
        {
            get
            {
                return BoltWeaponStack.Instance;
            }
        }
    }
}