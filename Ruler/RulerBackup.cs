...
namespace Ruler
{
    ...
    public class RulerB : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            labelWind = new Label();
            Button blackholeButton = new Button();
            SuspendLayout();
            
            blackholeButton.Size = new Size(64, 64);
            blackholeButton.Location = new Point(1000, 200);
            blackholeButton.TextAlign = ContentAlignment.MiddleCenter;
            blackholeButton.Image = Image.FromFile(@"H:\\GitHub\\ShellShockLive-Aim\\Resources\\blackhole.png");
            blackholeButton.Margin = new Padding(0);
            blackholeButton.FlatAppearance.BorderSize = 0;
            blackholeButton.TabStop = false;
            blackholeButton.FlatStyle = FlatStyle.Flat;
            blackholeButton.FlatAppearance.BorderColor = Color.FromArgb(0, 255, 255, 255);
            blackholeButton.Visible = false;
